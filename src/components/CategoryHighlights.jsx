...
const categories = [
  ...
  { id: 2, name: "Girls", icon: <Shirt className="w-8 h-8 text-pink-500" />, bg: "bg-pink-100" },
  { id: 3, name: "Shoes", icon: <Footprints className="w-8 h-8 text-blue-300" />, bg: "bg-gray-100" },
